...
const HomeScreen: React.FC = () => {
    ...
    return (
      ...
      >
        ...
        <View style={styles.infoBlock}>
          ...
          <Text style={styles.meta} numberOfLines={1}>📅 {startDate} - {endDate}</Text>
          <Text style={styles.meta} numberOfLines={1}>📸 {event.media_count} medya</Text>
        </View>
      </TouchableOpacity>
    )
  }
  ...
  // Aktif etkinlikler - başlangıç tarihine göre sırala (yakın olan üstte)
